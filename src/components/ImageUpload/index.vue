...
// 需要实例化
const cos = new COS({
  SecretId: 'AKIDVpthEUS9bmgJgmb9RSCgtpUszoMddMoz',
  SecretKey: 'oMefPs4zcy3rNcaHhqiKfjV1FCsHQIsB'
...
export default {
  data() {
    return {
      fileList: [
        // {
        //   url: 'https://pics3.baidu.com/feed/21a4462309f790529876c…bd585.jpeg?token=94fb40c2721c4ce2a4146594759cc6f9'
        // }
      ],
  ...
  methods: {
    ...
    upload(params) {
      if (params.file) {
        ...
        cos.putObject({
          // 配置
          Bucket: 'bde429-1313213560', // 存储桶名称
