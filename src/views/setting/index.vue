...
import { getRoleList, getCompanyInfo, deleteRole, getRoleDetail, updateRole, addRole, assignPerm, getPermissionList } from '@/api'
...
export default {
  ...
  methods: {
    ...
    async assignPerm(id) {
      this.permData = transListToTreeNew(await getPermissionList(), '0') // 转化list到树形数据
